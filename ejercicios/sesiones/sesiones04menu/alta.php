...
<head>
    ...
    <link rel="stylesheet" href="./styles/estilos.css" title="Color">
...
<body>
    ...
    <main>
        <div class="borde">
            <form action="./controller/procesar_alta.php" method="post" enctype="multipart/form-data">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="password" id="password" value="<?php echo !empty($_SESSION['usuario']) ? $_SESSION["usuario"]["password"] : ''; ?>" required></td>
                    </tr>
                    <tr>
                        <td><label for="password2">* Repita contraseña:</label></td>
                        <td><input type="password" name="password2" id="password2" value="<?php echo !empty($_SESSION['usuario']) ? $_SESSION["usuario"]["password2"] : ''; ?>" required></td>
                    </tr>
                    <tr>
